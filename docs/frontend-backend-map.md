...
| **Obligaciones / Obligations** | `/app/obligations` | `GET /api/v1/obligations`, `POST /api/v1/obligations`, `PATCH /api/v1/obligations/{id}`, `POST /api/v1/obligations/{id}/payments` | Estable |

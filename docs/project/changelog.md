...
- **Phase 4B**: Implemented obligation payment flows for specific periods and FIFO payments. Frontend sends typed payment payloads to Backend V1.6 and refreshes period data after success. Frontend does not calculate FIFO distribution, period balances, due states, account balances, or FX. Payment previews remain deferred unless Backend V1.6 exposes a dedicated preview contract.
